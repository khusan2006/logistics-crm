...
def ombor(request):
    ...
    for g in groups:
        ...
        # Who has asked for this marka, oldest first. The kg are NOT taken out of
        # the shelf figure — a bron promises, it does not hold — so the two numbers
        # sit side by side and `short` says when more is promised than has landed.
