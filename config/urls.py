...
urlpatterns = [
    ...
    path("customers/<int:pk>/location/", crm_views.customer_location, name="customer_location"),
    ...
    path("contracts/<int:pk>/close-short/", crm_views.contract_close_short,
         name="contract_close_short"),
    path("contracts/<int:pk>/reopen-short/", crm_views.contract_reopen_short,
         name="contract_reopen_short"),
