...
class TestBronsDoNotBlockOrdinarySales:
    def test_bronned_kg_can_still_be_sold_over_the_counter(self, admin_client, db):
        """A mijoz walks in while the granula is bronned by somebody else. The bron
        is a promise, not a lock — the sotuv goes through."""
